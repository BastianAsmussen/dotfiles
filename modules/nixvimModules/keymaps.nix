{
  # Every non-plugin-local keybinding.
  flake.nixvimModules.keymaps = _: {
    keymaps =
      let
      ...
      [
        ...
        (mapKeyWithOpts "n" "<leader>u" "<cmd>UndotreeToggle<CR>" {
          desc = "Undotree: Toggle the [u]ndo tree.";
        })
        ...
        # Toggle Tuxedo TUI.
        (mapKeyWithOpts "n" "<leader>tt" "<cmd>Tuxedo<CR>" {
          desc = "[T]oggle [T]uxedo";
        })
