        ...
        if inPureMode then
              ...
              let
                ...
                toNum =
                  ...
                  lib.lists.findFirstIndex (
                    c': c' == c
                  ) (throw "Cannot convert hash to integer, '${c}' not in hex array!") hexChars;
              in
          ...
          let
            ...
            toNum =
              ...
              foldl (
                acc: c:
                (acc * 16) + (lib.lists.findFirstIndex (x: x == c) 0 (stringToCharacters "0123456789abcdef"))
              ) 0 (stringToCharacters (substring 0 8 str));
          in
          toNum combined;
