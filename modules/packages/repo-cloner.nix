{
  perSystem =
    ...
    {
      packages.repo-cloner =
        let
          inherit (lib) getExe;
          drv = pkgs.writeShellScriptBin "repo-cloner" ''
        ...
        // {
          meta = {
            description = "Mirror every GitHub repo for a user, sorting school vs personal projects.";
            license = lib.licenses.mit;
            maintainers = [ lib.maintainers.BastianAsmussen ];
            platforms = lib.platforms.linux;
            mainProgram = "repo-cloner";
          };
        };
    };
}
